...
const UserCalendarPage = () => {
  ...
  const getTypeColor = (type) => {
    switch (type) {
      case "holiday":
        return { bg: "#fed7aa", color: "#c2410c", label: t("holiday_type") };
      case "exam":
        return { bg: "#fee2e2", color: "#dc2626", label: t("exam_type") };
      case "meeting":
        return { bg: "#dbeafe", color: "#2563eb", label: t("meeting_type") };
      default:
        return {
          bg: "#d1fae5",
          color: "#065f46",
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>{t("upcoming_events_dates")}</p>
      </div>
            ...
            return (
              <div key={event.id} style={styles.eventCard}>
                <div style={styles.eventDateBox}>
                  ...
                  <div style={styles.eventMonth}>{monthName}</div>
                </div>
